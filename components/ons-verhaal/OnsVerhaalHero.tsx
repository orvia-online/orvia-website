...
export default function OnsVerhaalHero() {
  return (
    <section className="bg-white section-padding pt-[96px] md:pt-[120px] lg:pt-[190px] pb-12 md:pb-16 lg:pb-[62px]">
      <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-16 max-w-[1290px] mx-auto">

        {/* Text column */}
        <div className="w-full lg:flex-1">
          <h1 className="font-heading font-bold text-orvia-dark text-[28px] md:text-[34px] lg:text-[40px] leading-[1.2] mb-6 lg:mb-8">
        ...
        {/* Photo column */}
        <div className="relative w-full lg:w-[564px] lg:flex-shrink-0 lg:overflow-hidden xl:overflow-visible">
          ...
          <div className="absolute bottom-[16px] left-0 lg:-left-[29%] w-[80%] lg:w-[105%] pointer-events-none select-none">
            <Image
