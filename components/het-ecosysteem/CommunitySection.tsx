      ...
      <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start max-w-[1290px] mx-auto">
        ...
        <div className="w-full lg:flex-1">
          ...
          <a href="#contact" className="inline-flex items-center group">
            <span className="h-12 bg-orvia-lime rounded-full flex items-center pl-6 pr-4 -mr-2 font-display font-bold text-[14px] text-orvia-dark group-hover:bg-[#c0d03a] transition-colors">
              Ik wil iets bijdragen
            </span>
            <span className="relative z-10 flex-shrink-0 w-12 h-12 bg-orvia-lime rounded-full flex items-center justify-center text-orvia-dark group-hover:bg-[#c0d03a] transition-colors">
