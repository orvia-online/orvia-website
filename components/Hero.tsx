...
export default function Hero() {
  return (
    <section className="relative min-h-[500px] md:min-h-[580px] lg:h-[643px] bg-orvia-dark overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 h-full flex flex-col justify-end px-5 md:px-10 lg:px-[75px] pt-[80px]">
        <div className="max-w-[1290px] mx-auto w-full pb-12 md:pb-16 lg:pb-[100px]">
          ...
          <p className="font-display font-semibold text-white text-[18px] lg:text-[22px] tracking-[0.66px] mb-3 lg:mb-4 max-w-[480px]">
            Blijven hangen maakt alles week.
            <br />
            Wij brengen beweging terug.
          </p>
